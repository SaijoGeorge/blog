...
var setShareCount = function(dataCount){
	...
	$('#marketingtoolio_score').text(" Score: " + calcMarketingtoolioStats(dataCount));


	$('#facebook_perc').text("Facebook Shares: " + (Math.round(parseInt(dataCount.facebook)/parseInt(dataCount.facebook_total))*100) + "%");
	$('#facebook_like_perc').text("Facebook Likes: " + (Math.round(parseInt(dataCount.facebook_like)/parseInt(dataCount.facebook_total))*100) + "%");
	$('#facebook_comment_perc').text("Facebook Comments: " + (Math.round(parseInt(dataCount.facebook_comment)/parseInt(dataCount.facebook_total))*100) + "%");
